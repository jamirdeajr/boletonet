...
{
    [TestClass]
    public class BancoDeutscheTeste
    {
        #region Carteira 16
        ...
        private BoletoBancario GerarBoletoCarteira16()
        {
            ...
            boletoBancario.CodigoBanco = 487;
        ...
        [TestMethod]
        public void Deutsche_Carteira_16_NossoNumero()
        {
        ...
        [TestMethod]
        public void Deutsche_Carteira_16_LinhaDigitavel()
        {
            var boletoBancario = GerarBoletoCarteira16();

            boletoBancario.Boleto.Valida();

            string linhaDigitavelValida = "48790.41318 60097.017101 92000.291606 2 64950000012300";

            Assert.AreEqual(boletoBancario.Boleto.CodigoBarra.LinhaDigitavel, linhaDigitavelValida, "Linha digitável inválida");
        }

        [TestMethod]
        public void Deutsche_Carteira_16_CodigoBarra()
        {
            var boletoBancario = GerarBoletoCarteira16();

            boletoBancario.Boleto.Valida();

            string codigoBarraValida = "48792649500000123000413160097017109200029160";
        ...
        private BoletoBancario GerarBoletoCarteira09()
        {
            ...
            //Boleto boleto = new Boleto(vencimento, 7620, "09", "299621", cedente);
            //boleto.NumeroDocumento = "299621";

            //Boleto boleto = new Boleto(vencimento, 7620, "09", "1122334456", cedente);
            //boleto.NumeroDocumento = "1122334456";

            Boleto boleto = new Boleto(vencimento, 7620, "09", "299626", cedente);
            boleto.NumeroDocumento = "0000299626";
        ...
        [TestMethod]
        public void Deutsche_Carteira_09_NossoNumero()
        {
            var boletoBancario = GerarBoletoCarteira09();

            boletoBancario.Boleto.Valida();

            string nossoNumeroValido = "009/0000299626-0";

            Assert.AreEqual(boletoBancario.Boleto.NossoNumero, nossoNumeroValido, "Nosso número inválido");
        }

        [TestMethod]
        public void Deutsche_Carteira_09_LinhaDigitavel()
        {
            var boletoBancario = GerarBoletoCarteira09();

            boletoBancario.Boleto.Valida();

            string linhaDigitavelValida = "48790.53909 90000.001819 94003.246306 3 53580000762000";

            Assert.AreEqual(boletoBancario.Boleto.CodigoBarra.LinhaDigitavel, linhaDigitavelValida, "Linha digitável inválida");
        }

        [TestMethod]
        public void Deutsche_Carteira_09_LinhaDigitavel_ValorCobrado()
        {
            var boletoBancario = GerarBoletoComValorCobradoCarteira09();

            boletoBancario.Boleto.Valida();

            var linhaDigitavelValida = "48790.53909 90000.001819 94003.246306 1 53580000510000";

            Assert.AreEqual(boletoBancario.Boleto.CodigoBarra.LinhaDigitavel, linhaDigitavelValida, "Linha digitável inválida");
        }

        [TestMethod]
        public void Deutsche_Carteira_09_CodigoBarra()
        {
            var boletoBancario = GerarBoletoCarteira09();

            boletoBancario.Boleto.Valida();

            string codigoBarraValida = "48793535800007620000539090000001819400324630";

            Assert.AreEqual(boletoBancario.Boleto.CodigoBarra.Codigo, codigoBarraValida, "Código de Barra inválido");
        }

        [TestMethod]
        public void Deutsche_Carteira_09_CodigoBarra_ValorCobrado()
        {
            var boletoBancario = GerarBoletoComValorCobradoCarteira09();

            boletoBancario.Boleto.Valida();

            var codigoBarraValida = "48791535800005100000539090000001819400324630";

            Assert.AreEqual(boletoBancario.Boleto.CodigoBarra.Codigo, codigoBarraValida, "Código de Barra inválido");
        }

        [TestMethod]
        public void Deutsche_Carteira_09_ArquivoRemessa()
        {
            ...
            objBOLETO.EspecieDocumento = new EspecieDocumento(487,"12");
            ...
            objREMESSA.GerarArquivoRemessa("09", new Banco(487), objCEDENTE, objBOLETOS, mem, 1000);


        }

        [TestMethod]
        public void Deutsche_Carteira_09_ArquivoRetorno400() {
            ...
            if (arquivo != string.Empty) {
                using (FileStream fs = new FileStream(arquivo, FileMode.Open, FileAccess.Read)) {
                    ret.LerArquivoRetorno(new Banco(487), fs);
                }
        ...
        [TestMethod]
        public void Deutsche_Carteira_25_NossoNumero()
        {
        ...
        [TestMethod]
        public void Deutsche_Carteira_25_LinhaDigitavel()
        {
            var boletoBancario = GerarBoletoCarteira25();

            boletoBancario.Boleto.Valida();

            string linhaDigitavelValida = "48790.05420 59700.000520 87014.887001 1 65880000046940";

            Assert.AreEqual( boletoBancario.Boleto.CodigoBarra.LinhaDigitavel, linhaDigitavelValida, "Linha digitável inválida" );
        }

        [TestMethod]
        public void Deutsche_Carteira_25_CodigoBarra()
        {
            var boletoBancario = GerarBoletoCarteira25();

            boletoBancario.Boleto.Valida();

            string codigoBarraValida = "48791658800000469400054259700000528701488700";
        ...
        [TestMethod]
        public void Deutsche_Carteira_26_NossoNumero()
        {
        ...
        [TestMethod]
        public void Deutsche_Carteira_26_LinhaDigitavel()
        {
            var boletoBancario = GerarBoletoCarteira26();

            boletoBancario.Boleto.Valida();

            string linhaDigitavelValida = "48790.05420 69700.000529 87014.887001 5 65880000046940";

            Assert.AreEqual(boletoBancario.Boleto.CodigoBarra.LinhaDigitavel, linhaDigitavelValida, "Linha digitável inválida");
        }

        [TestMethod]
        public void Deutsche_Carteira_26_CodigoBarra()
        {
            var boletoBancario = GerarBoletoCarteira26();

            boletoBancario.Boleto.Valida();

            string codigoBarraValida = "48795658800000469400054269700000528701488700";
